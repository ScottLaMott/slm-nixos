...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/slm/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/slm/wall.png"
